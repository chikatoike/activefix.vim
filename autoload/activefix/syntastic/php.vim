" this file is based on syntastic/syntax_checkers/php.vim
"============================================================================
"File:        php.vim
...
function! activefix#syntastic#php#GetHighlightRegex(item)
...
function! activefix#syntastic#php#config()

    let errors = []

    let makeprg = "php -l -d error_reporting=E_ALL -d display_errors=0 -d error_log='' ".shellescape(activefix#syntastic#expand_target('php', '%'))
...
function! s:GetPHPCSErrors()
    let makeprg = "phpcs " . g:syntastic_phpcs_conf . " --report=csv ".shellescape(activefix#syntastic#expand_target('php', '%'))
