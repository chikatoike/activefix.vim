" this file is based on syntastic/syntax_checkers/zpt.vim
"============================================================================
"File:        zpt.vim
...
function! activefix#syntastic#zpt#config()
    let makeprg="zptlint ".shellescape(activefix#syntastic#expand_target('zpt', '%'))
