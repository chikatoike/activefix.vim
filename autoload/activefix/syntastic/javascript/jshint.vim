" this file is based on syntastic/syntax_checkers/javascript/jshint.vim
"============================================================================
"File:        jshint.vim
...
function! activefix#syntastic#javascript#jshint#config()
    ...
    let makeprg = 'jshint ' . shellescape(activefix#syntastic#expand_target('javascript/jshint', "%")) . args
