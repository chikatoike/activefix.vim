" this file is based on syntastic/syntax_checkers/javascript/closurecompiler.vim
"============================================================================
...
function! activefix#syntastic#javascript#closurecompiler#config()
    if exists("g:syntastic_javascript_closure_compiler_file_list")
        ...
        let file_list = shellescape(activefix#syntastic#expand_target('javascript/closurecompiler', '%'))
    endif
