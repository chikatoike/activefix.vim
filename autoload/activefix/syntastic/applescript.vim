" this file is based on syntastic/syntax_checkers/applescript.vim
"==============================================================================
...
function! activefix#syntastic#applescript#config()
    let makeprg = 'osacompile -o ' . tempname() . '.scpt '. shellescape(activefix#syntastic#expand_target('applescript', '%'))
