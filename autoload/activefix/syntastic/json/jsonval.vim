" this file is based on syntastic/syntax_checkers/json/jsonval.vim
"============================================================================
"File:        jsonval.vim
...
function! activefix#syntastic#json#jsonval#config()
    " based on https://gist.github.com/1196345
    let makeprg = 'jsonval '. shellescape(activefix#syntastic#expand_target('json/jsonval', '%'))
