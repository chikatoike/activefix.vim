" this file is based on syntastic/syntax_checkers/matlab.vim
"============================================================================
"File:        matlab.vim
...
function! activefix#syntastic#matlab#config()
    let makeprg = 'mlint -id $* '.shellescape(activefix#syntastic#expand_target('matlab', '%'))
