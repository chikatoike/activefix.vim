" this file is based on syntastic/syntax_checkers/coffee.vim
"============================================================================
"File:        coffee.vim
...
function! activefix#syntastic#coffee#config()
    let makeprg = 'coffee -c -l -o /tmp '.shellescape(activefix#syntastic#expand_target('coffee', '%'))
...
function s:GetCoffeeLintErrors()
    let coffeelint = 'coffeelint --csv '.g:syntastic_coffee_lint_options.' '.shellescape(activefix#syntastic#expand_target('coffee', '%'))
    return { 'makeprg': coffeelint, 'errorformat': '%f\,%l\,%trror\,%m', 'subtype': 'Style' }
