" this file is based on syntastic/syntax_checkers/vala.vim
"============================================================================
"File:        vala.vim
...
function! activefix#syntastic#vala#GetHighlightRegex(pos)
...
function! activefix#syntastic#vala#config()
    let vala_pkg_args = join(map(s:GetValaModules(), '"--pkg ".v:val'), ' ')
    let makeprg = 'valac -C ' . vala_pkg_args . ' ' .shellescape(activefix#syntastic#expand_target('vala', '%'))
