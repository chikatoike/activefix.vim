" this file is based on syntastic/syntax_checkers/fortran.vim
"============================================================================
"File:        fortran.vim
...
function! activefix#syntastic#fortran#config()
    ...
    let makeprg .= ' ' . shellescape(activefix#syntastic#expand_target('fortran', '%'))
