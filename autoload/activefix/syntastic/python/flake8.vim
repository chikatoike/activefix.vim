" this file is based on syntastic/syntax_checkers/python/flake8.vim
"============================================================================
"File:        flake8.vim
...
"
"============================================================================
function! activefix#syntastic#python#flake8#GetHighlightRegex(i)
...
function! activefix#syntastic#python#flake8#config()
    let makeprg = 'flake8 '.g:syntastic_python_checker_args.' '.shellescape(activefix#syntastic#expand_target('python/flake8', '%'))
