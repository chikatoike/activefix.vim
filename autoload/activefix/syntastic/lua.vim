" this file is based on syntastic/syntax_checkers/lua.vim
"============================================================================
"File:        lua.vim
...
function! activefix#syntastic#lua#GetHighlightRegex(pos)
...
function! activefix#syntastic#lua#config()
    let makeprg = 'luac -p ' . shellescape(activefix#syntastic#expand_target('lua', '%'))
