" this file is based on syntastic/syntax_checkers/xml.vim
"============================================================================
"File:        xml.vim
...
function! activefix#syntastic#xml#config()

    let makeprg="xmllint --xinclude --noout --postvalid " . shellescape(activefix#syntastic#expand_target('xml', "%:p"))
